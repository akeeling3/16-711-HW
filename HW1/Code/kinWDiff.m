...
%Forward kinematics for a snake robot with given angles
    ...
    for i = 1:num_links
        ...
        derivRx = [1 0 0; 0 -sin(x_angle) -cos(x_angle); 0 cos(x_angle) -sin(x_angle)];
        derivRy = [-sin(y_angle) 0 -cos(y_angle); 0 1 0; -cos(y_angle) 0 -sin(y_angle)];
        derivRz = [-sin(z_angle) -cos(z_angle) 0; cos(z_angle) -sin(z_angle) 0; 0 0 1];
        
        link_pos = transpose(derivRx*derivRy*derivRz*link);
