...
int main (int argc, char **argv)
{
  ...
  */
  ...
  fn.stop = 0;
#ifdef WIN32
  fn.path_to_textures = "C:/akeeling/Documents/KDC_HW/HW3/lander06/useful/drawstuff-windows/textures";
#else
  fn.path_to_textures = "/home/akeeling/KDC_HW3/lander06/useful/drawstuff-linux/textures";
#endif
